    ...
    <div class="ui grid container">
      ...
      <div class="bottom aligned twelve wide column">
        ...
        <div class="ui right floated horizontal list" v-if="isOwner">
          <router-link to="/settings/profile" class="ui primary button">
            Edit profile
          </router-link>
        </div>

        <div class="ui right floated horizontal list" v-else>
          <button 
...
export default {
  ...
  methods: {
    ...
    unFollow (userId) {
      ...
      .then(response => {
        this.authUser.following = this.authUser.following.filter(user => {
